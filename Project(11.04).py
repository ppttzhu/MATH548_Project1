...
# -------------Graph Solution------------
# -------------Test------------
date = input("Stock price date(0000-00-00) : ")
cp = input("indicator 1 for call, -1 for put : ")
k = input("Strike : ")
t = input("time to maturity : ")
r = input("risk free rate : ")
n = input("height of the binomial tree : ")
b = input("dividend rate of underlying asset : ")
startdate = input("start date (0000-00-00) : ")
T = input("Time : ")
...
TWIT = data.DataReader(name = 'TWTR', data_source = 'yahoo',start = '2017-11-04')
myframe = TWIT['Adj Close']
sigma = myframe.std()
sigma = float(sigma)

s = TWIT['Adj Close'][date]

stock = Pinance("TWTR")

if (cp == 1):
    stock.get_options('2019-03-15', 'C', k)
else:
    stock.get_options('2019-03-15', 'P', k)
...
#-----------------result---------------------
binomial_tree_european_analytic11 = binomial_tree_european_analytic(cp, s, k, t, r, sigma, n)
bs_formula11 = bs_formula(cp, s, k, t, r, b, sigma)
binomial_tree_american11 = binomial_tree_american(cp, s, k, t, r, sigma, n)
baw_formula11 = baw_formula(cp, s, k, t, r, b, sigma)
